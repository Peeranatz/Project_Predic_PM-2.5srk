...
from model_js016_7days import predict_pm25_arima_js016_7days
from model_js016_14days import predict_pm25_arima_js016_14days
from model_js018_7days import predict_pm25_arima_js018_7days
from model_js018_14days import predict_pm25_arima_js018_14days
...
def register_callbacks(app):
    ...
    def predict_pm25(n_clicks, days_to_forecast, click_data):
        ...
        try:
            ...
            elif clicked_location == "JSPS016":
                if days_to_forecast == 7:
                    predicted_values, future_dates = predict_pm25_arima_js016_7days(
                        days_to_forecast
                    )
                elif days_to_forecast == 14:
                    predicted_values, future_dates = predict_pm25_arima_js016_14days(
                        days_to_forecast
                    )
            elif clicked_location == "JSPS018":
                if days_to_forecast == 7:
                    predicted_values, future_dates = predict_pm25_arima_js018_7days(
                        days_to_forecast
                    )
                elif days_to_forecast == 14:
                    predicted_values, future_dates = predict_pm25_arima_js018_14days(
                        days_to_forecast
                    )
            else:
